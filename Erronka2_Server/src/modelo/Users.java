...
public class Users implements java.io.Serializable {
	...
	public String toString() {
	    // Forzar la inicialización de las colecciones
	    Hibernate.initialize(matriculacioneses);
	    Hibernate.initialize(reunionesesForProfesorId);
	    Hibernate.initialize(reunionesesForAlumnoId);
	    Hibernate.initialize(horarioses);

	    // Devolver el string con todos los datos, incluyendo el tamaño de las colecciones
	    return "Users [id=" + id +
	            ", tipos=" + tipos + 
	            ", email=" + email + 
	            ", username=" + username + 
